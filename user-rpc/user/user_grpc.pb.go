...
func (c *userServiceClient) Add(ctx context.Context, in *User, opts ...grpc.CallOption) (*AddResp, error) {
	out := new(AddResp)
...
type UserServiceServer interface {
	Add(context.Context, *User) (*AddResp, error)
...
func (UnimplementedUserServiceServer) Add(context.Context, *User) (*AddResp, error) {
